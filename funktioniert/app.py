...
# Configuration
ISERV_CLIENT_ID = os.environ.get("ISERV_CLIENT_ID", None)
ISERV_CLIENT_SECRET = os.environ.get("ISERV_CLIENT_SECRET", None)
ISERV_DISCOVERY_URL = (
    "https://tls-giessen.eu/.well-known/openid-configuration"
)
...
def index():
    if current_user.is_authenticated:
        ...
        return '<a class="button" href="/login">IServ Login</a>'
